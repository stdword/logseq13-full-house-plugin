...
import { InsertAs, insertTemplate, insertTemplateButton } from '../logic'
...
async function insertLogic(
    ...
    if (insertAs === 'Button') {
        await insertTemplateButton(blockUUIDs[0], item.uuid)
        return
    }
...
function InsertUI({ blockUUIDs, isSelectedState }) {
    ...
    const insertHighlightedItem = async () => {
        ...
        await insertLogic(
            ...
            blockUUIDs,
            isSelectedState,
            shiftKeyPressed && cmdKeyPressed ? 'Button' : (cmdKeyPressed ? 'View' : 'Template'),
        )
    }
                    ...
                    <div id="content">
                        ...
                        <footer>
                            <ul>
                                ...
                                <li style={blockUUIDs.length ? "" : "opacity: 0"}>|</li>
                                <li style={blockUUIDs.length ? "" : "opacity: 0"}>Insert as:</li>
